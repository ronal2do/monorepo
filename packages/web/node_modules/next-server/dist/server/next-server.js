...
class Server {
    constructor({ dir = '.', staticMarkup = false, quiet = false, conf = null, } = {}) {
        ...
        this.pagesManifest = path_1.join(this.distDir, this.nextConfig.target || 'server', constants_1.PAGES_MANIFEST);
    ...
    async handleApiRequest(req, res, pathname) {
        ...
        api_utils_1.apiResolver(req, res, params, resolverFunction ? require(resolverFunction) : undefined);
    }
    /**
